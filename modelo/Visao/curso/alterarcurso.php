...
<div class="container mt-4">
    <h2 class="mb-4">Alterar Curso</h2>
    <form method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="nome" class="form-label">Novo Nome do Curso</label>
            <input type="text" class="form-control" name="nome" required>
        </div>
        <div class="mb-3">
            <label for="duracao" class="form-label">Nova Duração (semestres)</label>
            <input type="number" class="form-control" name="duracao" required min="1" max="20">
        </div>
